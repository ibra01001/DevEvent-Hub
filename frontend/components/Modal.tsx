  ...
  return (
    ...
    >
      <div
        ...
        className={`w-full ${maxWidthClasses} bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl shadow-2xl overflow-hidden flex flex-col transition-all transform scale-100 max-h-[90vh]`}
      >
        {/* Header */}
        ...
        {/* Footer */}
        {footer && (
          <div className="p-4 bg-zinc-50 dark:bg-zinc-950/40 border-t border-zinc-100 dark:border-zinc-800/80 flex items-center justify-end gap-3">
            {footer}
          </div>
        )}
      </div>
